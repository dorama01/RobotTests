*** Variables ***
${ACCEPTER_COOKIES_BUTTON}    xpath=//button[contains(text(), 'Accepter') or contains(text(), 'J’accepte')]
${CONNECTEZ_VOUS_LINK}        xpath=//div[@class='c-access__compte js-access__compte']/a
